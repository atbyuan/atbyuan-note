...
public class PropertyUtil {
    ...
    public static Map<String, HashMap> contrast(MutablePropertySources beforeSources,
    ...
    private static Map<String, HashMap> changesAll(Map<String, Object> before,
    ...
    private static Map<String, Object> changes(Map<String, Object> before,
                                        Map<String, Object> after) {
        Map<String, Object> result = new HashMap<String, Object>();
        for (String key : before.keySet()) {
            if (!after.containsKey(key)) {
